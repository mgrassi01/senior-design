...
// void IRAM_ATTR tilt_isr(const int gpio_num, int level){
...
// }
// void IRAM_ATTR isr_tilt_F_rising(){
//   tilt_isr(TILT_PIN_F, 1);
// }
// void IRAM_ATTR isr_tilt_B_rising(){
//   tilt_isr(TILT_PIN_B, 1);
// }
// void IRAM_ATTR isr_tilt_L_rising(){
//   tilt_isr(TILT_PIN_L, 1);
// }
// void IRAM_ATTR isr_tilt_R_rising(){
//   tilt_isr(TILT_PIN_R, 1);
// }

// void IRAM_ATTR isr_tilt_F_falling(){
//   tilt_isr(TILT_PIN_F, 0);
// }
// void IRAM_ATTR isr_tilt_B_falling(){
//   tilt_isr(TILT_PIN_B, 0);
// }
// void IRAM_ATTR isr_tilt_L_falling(){
//   tilt_isr(TILT_PIN_L, 0);
// }
// void IRAM_ATTR isr_tilt_R_falling(){
//   tilt_isr(TILT_PIN_R, 0);
// }
...
//   attachInterrupt(digitalPinToInterrupt(TILT_PIN_F), isr_tilt_F_rising, RISING); // not sure this will work
//   attachInterrupt(digitalPinToInterrupt(TILT_PIN_B), isr_tilt_B_rising, RISING); // not sure this will work
//   attachInterrupt(digitalPinToInterrupt(TILT_PIN_L), isr_tilt_L_rising, RISING); // not sure this will work
//   attachInterrupt(digitalPinToInterrupt(TILT_PIN_R), isr_tilt_R_rising, RISING); // not sure this will work

//   attachInterrupt(digitalPinToInterrupt(TILT_PIN_F), isr_tilt_F_rising, FALLING); // not sure this will work
//   attachInterrupt(digitalPinToInterrupt(TILT_PIN_B), isr_tilt_B_rising, FALLING); // not sure this will work
//   attachInterrupt(digitalPinToInterrupt(TILT_PIN_L), isr_tilt_L_rising, FALLING); // not sure this will work
//   attachInterrupt(digitalPinToInterrupt(TILT_PIN_R), isr_tilt_R_rising, FALLING); // not sure this will work 
